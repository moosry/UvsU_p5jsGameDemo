...
export const Assets = {
  ...
  async loadAll(p) {
    ...
    // 分身贴图
    this.cloneImg_right = results[16];
    this.cloneImg_left = results[17];
    this.cloneImg_up = results[18];
    this.cloneImg_upRight = results[19];
    this.cloneImg_upLeft = results[20];
    // 地块贴图
    this.tileImage_goal = results[21];
    this.tileImage_ground = results[22];
    this.tileImage_platform = results[23];
  }
};
