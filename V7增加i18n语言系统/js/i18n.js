...
const _dict = {
  en: {
    ...
    rec_title_idle:        'Press E to Start Recording',
    rec_sub_max:           'Max Record Duration',
    rec_sub_press_e_end:   'Press E to stop',
    rec_sub_ready_prefix:  'Press R to replay, E to re-record  Recorded',
  ...
  zh: {
    ...
    // ── Opening Story ────────────────────────────────────────────────
    btn_skip:       '按 [ENTER] 跳过',
    notebook_front: '[游戏操作]<br>&nbsp;&nbsp;&nbsp;<br>&nbsp;&nbsp;按 [R]<br>&nbsp;&nbsp;&nbsp;&nbsp;<br>> 开始录制<br>> 结束录制<br>> 开始回放<br>> 结束回放',
    notebook_back:  '&nbsp;用 [WASD]<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;↓<br>进入门<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;↓<br>&nbsp;>&nbsp;>&nbsp;胜利&nbsp;<&nbsp;<&nbsp;',
    story_loading:  '故事加载中...',
    ...
    rec_title_idle:        '按 E 开始录制',
    rec_sub_max:           '最大录制时长',
    rec_sub_press_e_end:   '按 E 结束录制',
    rec_sub_ready_prefix:  '按 R 回放，按 E 重新录制  已录制',
    rec_hud_label:         '录制面板',
  },
};
