...
export const Assets = {
  ...
  async loadAll(p) {
    ...
    // 分身贴图
    this.cloneImg_right = results[18];
    this.cloneImg_left = results[19];
    this.cloneImg_up = results[20];
    this.cloneImg_upRight = results[21];
    this.cloneImg_upLeft = results[22];
    // 地块贴图
    this.tileImage_goal = results[23];
    this.tileImage_ground = results[24];
    this.tileImage_platform = results[25];
  }
};
