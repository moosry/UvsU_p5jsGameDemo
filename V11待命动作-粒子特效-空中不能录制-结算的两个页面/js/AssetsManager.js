...
export const Assets = {
  ...
  async loadAll(p) {
    ...
    this.storyTexts_en = results[10];
    this.storyTexts_zh = results[11];
    // 本体贴图
    this.playerImg_right = results[12];
    this.playerImg_left = results[13];
    this.playerImg_up = results[14];
    this.playerImg_upRight = results[15];
    this.playerImg_upLeft = results[16];
    this.playerImg_dead = results[17];
    this.playerIdleImgs = [results[18], results[19], results[20], results[21], results[22], results[23]];
    // 分身贴图
    this.cloneImg_right = results[24];
    this.cloneImg_left = results[25];
    this.cloneImg_up = results[26];
    this.cloneImg_upRight = results[27];
    this.cloneImg_upLeft = results[28];
    this.cloneIdleImgs = [results[29], results[30], results[31], results[32], results[33], results[34]];
    // 地块贴图
    this.tileImage_goal = results[35];
    this.tileImage_ground = results[36];
    this.tileImage_platform = results[37];
  }
};
